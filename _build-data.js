...
const CLIENT = {
  ...
  description: 'Premium painting contractor serving Timnath, Windsor, Severance & Northern Colorado. Licensed, insured, Eco-Painter Certified. Call (970) 670-3965.',
};

const SERVICES = [
  { label: 'Exterior Painting',   slug: 'exterior-painting',   icon: 'fa-solid fa-house',             img: 'img-4932-exterior.jpg', tagline: 'Coatings built to handle Colorado freeze-thaw cycles Ã¢â‚¬â€ rated for 7-10 years.' },
...
<strong>Project Management:</strong> You get a dedicated project lead, progress updates throughout the job, and full site cleanup. No subcontractors. No volume rushing.`,
    sidingTypes: [
      ...
      { type: 'Wood / Cedar', desc: "Natural wood demands oil-based primer on every bare surface. Checks, splits, and open grain get caulked with flexible elastomeric sealant. Colorado's dry climate pulls moisture out of wood faster than coastal climates â€” older wood siding requires more prep time, and we factor that into every quote." },
      ...
      { type: 'Vinyl Siding', desc: 'Paintable with the correct adhesion primer. Color selection matters here â€” going significantly darker than the original factory color can cause thermal expansion stress and may void manufacturer warranties. We assess this before quoting and advise accordingly.' },
    ...
    whyUs: `Our crew is owned, not subcontracted. That matters more than most homeowners realize â€” it means the same people who show up day one are there day five. No phone-tag with subs, no quality drop-off when we get busy and send whoever is available.

We are Eco-Painter Certified. That is a real credential covering application practices, environmental compliance, and chemical handling â€” not just a marketing badge. It is also why we have access to Sherwin-Williams and Benjamin Moore contractor programs that most local painters do not.
...
<strong>Final Day &mdash; Cleanup &amp; Walkthrough:</strong> Site cleanup, touch-ups, and a final walkthrough with you before any invoice is issued. You do not need to be home during the project â€” we coordinate access at the quote stage and send photos throughout.`,
    relatedServices: [
    ...
    faqs: [
      ...
      { q: 'Do you repair wood rot before painting?', a: 'Yes. Minor rot and damaged trim are repaired during prep â€” this is part of our standard process, not an add-on. Extensive structural damage may be referred to a carpenter, but we handle everything that is paint-adjacent.' },
      { q: 'What warranty do you offer on exterior painting?', a: 'We stand behind our work. If paint fails due to workmanship issues â€” peeling, adhesion failure, excessive fading â€” within the first year, we return and fix it. Sherwin-Williams Duration carries a Lifetime Limited warranty when applied by a certified contractor, which we are.' },
...
<strong>Execution:</strong> Same prep and coating standards as every Timnath Painting project  -  no shortcuts because the client is an HOA instead of an individual homeowner.`,
    faqs: [
      ...
      { q: 'What does HOA exterior painting cost?', a: 'HOA painting costs depend on number of units, building size, surface condition, and color change requirements. We provide per-unit pricing and bulk project estimates. Call (970) 670-3965 for a site assessment and quote.' },
    ],
  },
  'commercial-painting': {
    title: 'Commercial Painting in Northern Colorado',
    metaTitle: 'Commercial Painting Northern Colorado | Timnath Painting',
    metaDesc: 'Commercial painting in Northern Colorado. After-hours scheduling, minimal disruption, $2M liability. Call Timnath Painting: (970) 670-3965',
...
<strong>Product Selection:</strong> Stain type (oil vs. water-based), sheen level, and UV protection are selected based on wood species, sun exposure, and existing finish.`,
    faqs: [
      ...
      { q: 'What does fence staining cost in Northern Colorado?', a: 'Fence staining typically costs $2-$5 per linear foot depending on fence height, condition, number of sides, and stain type. A 150-foot privacy fence in average condition runs $600-$1,200. Call (970) 670-3965 for an accurate estimate.' },
    ],
  },
  'exterior-staining': {
    title: 'Exterior Staining in Northern Colorado',
    metaTitle: 'Exterior Staining Northern Colorado | Timnath Painting',
    metaDesc: 'Exterior staining for wood siding, decks & trim in Northern Colorado. Premium penetrating stains, proper prep. Call (970) 670-3965',
...
const CITY_DATA = {
  'timnath-co': {
    ...
    intro: `Timnath is one of the fastest-growing communities in Northern Colorado, with new construction neighborhoods and established HOA communities spreading east of I-25. The homes here are newer and premium Ã¢â‚¬â€ and the expectation for exterior appearance matches. Colorado's 28+ freeze-thaw cycles and intense UV exposure hit every home in Timnath the same way, regardless of age. Paint systems that aren't designed for Zone 5b conditions fail early.\n\nTimnath Painting is based here. We know the neighborhoods, the HOA requirements, and the local conditions better than anyone. Licensed, Insured, and Eco-Painter Certified with $2M general liability coverage.`,
    faqs: [
      { q: 'Do you serve the Timnath area?', a: 'Yes Ã¢â‚¬â€ Timnath is our home base. We serve all neighborhoods in Timnath including newer HOA communities east of I-25. We\x27re on-site in Timnath regularly and can typically schedule faster here than in other cities.' },
      { q: 'Do you work with HOAs in Timnath?', a: 'Yes. Many Timnath neighborhoods have HOA color approval requirements. We handle the approval documentation, provide color samples, and submit to the architectural review committee on your behalf. Most HOA approvals in this area take 2Ã¢â‚¬â€œ4 weeks, which we build into every project timeline.' },
      { q: 'How long does exterior paint last on new construction in Timnath?', a: 'Builder-grade paint applied on new construction homes typically lasts 4Ã¢â‚¬â€œ6 years before visible chalking, fading, and edge failures appear. We install premium Sherwin-Williams and Benjamin Moore systems rated for 7Ã¢â‚¬â€œ10 years using proper prep and two-coat minimum application.' },
      ...
      { q: 'How far in advance should I book exterior painting in Timnath?', a: 'Spring and early summer slots fill 4Ã¢â‚¬â€œ8 weeks out in Timnath. We recommend contacting us in March or April for MayÃ¢â‚¬â€œJune scheduling. We do accept late-season projects through October when weather permits.' },
    ],
  },
  'windsor-co': {
    label: 'Windsor',
    ...
    faqs: [
      ...
      { q: 'Do you handle HOA color approvals in Windsor?', a: 'Yes. Windsor has a number of HOA communities with strict color approval requirements. We handle the full documentation process Ã¢â‚¬â€ color samples, approval submissions, and compliance letters Ã¢â‚¬â€ on your behalf.' },
      { q: 'What exterior paint should I use on my Windsor home?', a: 'We specify Sherwin-Williams Duration, Emerald, or Benjamin Moore Aura for Windsor exteriors. These are 100% acrylic latex coatings formulated for Colorado\'s UV intensity and freeze-thaw cycling. Builder-grade or budget paints fail 2Ã¢â‚¬â€œ3 years faster in this climate.' },
      { q: 'How long does exterior painting take in Windsor?', a: 'Most residential exterior painting projects in Windsor take 3Ã¢â‚¬â€œ5 days from first day of prep to final coat. Larger homes, significant repair work, or HOA multi-unit projects run longer. We provide specific timelines during the quoting process.' },
      { q: 'Do you offer fence staining in Windsor?', a: 'Yes. Fence staining is one of our most common services in Windsor. We use penetrating oil and water-based stains that protect wood from Windsor\'s UV exposure and moisture cycles. Most fences need restaining every 3Ã¢â‚¬â€œ5 years.' },
    ],
  },
  'severance-co': {
    label: 'Severance',
    ...
    faqs: [
      ...
      { q: 'How does Colorado\'s climate affect exterior paint in Severance?', a: 'Northern Colorado sees 28+ freeze-thaw cycles annually. UV radiation at altitude is 10Ã¢â‚¬â€œ15% more intense than at sea level. These factors degrade budget exterior coatings in 3Ã¢â‚¬â€œ4 years. We use premium paint systems rated for 7Ã¢â‚¬â€œ10 years and apply proper prep including pressure washing, scraping, caulking, and spot priming before any topcoat.' },
      { q: 'Do you do fence staining in Severance?', a: 'Yes. Fence staining is common in Severance where newer homes have cedar and pine fencing. We use penetrating semi-transparent stains that protect the wood grain through Northern Colorado winters and summers, lasting 3Ã¢â‚¬â€œ5 years with proper prep.' },
      { q: 'Can you paint the exterior of an older farmhouse or rural property in Severance?', a: 'Yes. Older homes and rural properties often have more prep work involved Ã¢â‚¬â€ failed paint, wood rot, compromised caulk, and weathered surfaces. We assess all of this upfront and factor it into the quote. We don\'t charge extra for thorough prep; we treat it as part of every project.' },
      { q: 'How do I get a quote for exterior painting in Severance?', a: 'Call (970) 670-3965 or use the contact form on this page. We schedule on-site assessments in Severance and provide written quotes within 24 hours of the visit. We respond to all inquiries within a few minutes during business hours.' },
    ],
  },
  'fort-collins-co': {
    label: 'Fort Collins',
    ...
    intro: `Fort Collins is the largest city in Northern Colorado and has one of the most diverse housing stocks in the region Ã¢â‚¬â€ historic Craftsman and Victorian homes in Old Town, mid-century builds in established neighborhoods, and newer subdivisions spreading south and east. Each era of construction comes with its own set of coating challenges. Historic homes require careful prep, lead paint awareness, and specialty primers. Newer builds need proper topcoat systems, not just builder repaints.\n\nTimnath Painting serves Fort Collins with the same standards we apply everywhere Ã¢â‚¬â€ Licensed, Insured, Eco-Painter Certified, $2M general liability. Sherwin-Williams and Benjamin Moore coatings. No subcontractors.`,
    faqs: [
      ...
      { q: 'Can you paint historic homes in Old Town Fort Collins?', a: 'Yes. Older homes in Old Town require special attention Ã¢â‚¬â€ lead paint testing and containment on pre-1978 homes, oil-based primers for chalky or bare wood surfaces, and careful prep to avoid damaging historic trim detail. We\'re experienced with the specific challenges of older Fort Collins housing stock.' },
      { q: 'How long does exterior paint last on Fort Collins homes?', a: 'Most Fort Collins homes see the same Northern Colorado climate as the rest of the region Ã¢â‚¬â€ 28+ freeze-thaw cycles, intense UV, and temperature swings. Budget paint fails in 3Ã¢â‚¬â€œ4 years. Premium systems using Sherwin-Williams Duration or Benjamin Moore Aura last 7Ã¢â‚¬â€œ10 years with proper prep.' },
      ...
      { q: 'What Fort Collins neighborhoods do you serve?', a: 'We serve all of Fort Collins Ã¢â‚¬â€ Old Town, Midtown, Fossil Creek, Harmony, Rigden Farm, Sidehill, and new developments in southeast and southwest Fort Collins. Call (970) 670-3965 for availability in your specific neighborhood.' },
    ],
  },
  'loveland-co': {
    label: 'Loveland',
    ...
    intro: `Loveland sits along the Front Range at the foot of the Big Thompson Canyon Ã¢â‚¬â€ scenic, but that also means direct UV exposure, wind, and temperature swings that challenge exterior paint systems year-round. The city has a mix of established mid-century neighborhoods near downtown and newer developments spreading south and east toward Johnstown. Both require proper exterior coating systems to survive Northern Colorado's climate.\n\nTimnath Painting serves Loveland with the same Eco-Painter Certified crew, premium Sherwin-Williams and Benjamin Moore coatings, and thorough prep that protects every project for 7Ã¢â‚¬â€œ10 years. Licensed, Insured, $2M general liability.`,
    faqs: [
      ...
      { q: 'Do you stain fences and decks in Loveland?', a: 'Yes. Fence and deck staining is common in Loveland. We use penetrating semi-transparent stains that protect wood from UV damage and moisture, typically lasting 3Ã¢â‚¬â€œ5 years. Decks on the south or west side of homes in Loveland may need attention sooner due to sun exposure.' },
      { q: 'Can you paint older Loveland homes?', a: 'Yes. We handle older homes with the appropriate prep Ã¢â‚¬â€ scraping to stable substrate, oil-based or shellac primers on bare wood, elastomeric caulking on all gaps, and pressure washing before any coating goes on. Thorough prep is the difference between a 4-year job and a 10-year system.' },
      { q: 'How do I get a painting quote in Loveland?', a: 'Call (970) 670-3965 or fill out the quote form on this page. We schedule on-site assessments in Loveland and provide written quotes within 24 hours. We respond to all quote requests within minutes during business hours.' },
    ],
  },
  'greeley-co': {
    label: 'Greeley',
    ...
    faqs: [
      ...
      { q: 'What exterior paint works best in Greeley\'s climate?', a: 'We specify Sherwin-Williams Duration, Emerald, or Benjamin Moore Aura for Greeley exteriors. These 100% acrylic coatings are formulated for high UV exposure and thermal cycling. They outperform budget paints by 3Ã¢â‚¬â€œ5 years in Northern Colorado conditions.' },
      { q: 'Do you offer fence and deck staining in Greeley?', a: 'Yes. Fence and deck staining is available in Greeley. We use penetrating oil and water-based stains that protect wood from Greeley\'s UV exposure and moisture cycles, typically lasting 3Ã¢â‚¬â€œ5 years per application.' },
    ],
  },
  'wellington-co': {
    label: 'Wellington',
    ...
    faqs: [
      ...
      { q: 'Can you paint acreage properties and outbuildings in Wellington?', a: 'Yes. Rural properties, detached garages, barns, and outbuildings are within our scope. We assess each structure and apply appropriate coatings Ã¢â‚¬â€ exterior latex for residential structures, and elastomeric or industrial coatings for metal buildings and agricultural structures where appropriate.' },
      { q: 'How does wind affect exterior paint in Wellington?', a: 'Wellington is exposed to consistent Front Range winds that accelerate paint breakdown, especially on north and west-facing surfaces. Wind-driven moisture and debris abrade coating surfaces over time. This makes proper prep Ã¢â‚¬â€ scraping, priming, and caulking Ã¢â‚¬â€ even more important than it is in more sheltered locations.' },
      { q: 'Do you stain fences and decks in Wellington?', a: 'Yes. Fence and deck staining is common in Wellington where wood fencing is standard on acreage and suburban properties alike. We use penetrating stains that hold up to Northern Colorado\'s weather cycles, lasting 3Ã¢â‚¬â€œ5 years per application.' },
      { q: 'How do I book exterior painting in Wellington?', a: 'Call (970) 670-3965 or submit the quote form on this page. We schedule on-site assessments in Wellington and provide written quotes within 24 hours of the visit.' },
    ],
  },
  'johnstown-co': {
    label: 'Johnstown',
    ...
    intro: `Johnstown has grown significantly along the I-25 corridor between Loveland and Greeley, with newer residential neighborhoods and commercial development continuing to expand. Most homes here are newer builds Ã¢â‚¬â€ but newer doesn\'t mean immune to Colorado\'s climate. Freeze-thaw cycles, intense UV, and temperature swings that can exceed 60Ã‚Â°F in a single day stress even recently applied builder-grade paint systems.\n\nTimnath Painting serves Johnstown with the same approach: thorough prep, premium Sherwin-Williams and Benjamin Moore coatings rated for 7Ã¢â‚¬â€œ10 years, and an Eco-Painter Certified crew. Licensed, Insured, $2M general liability.`,
    faqs: [
      ...
      { q: 'How long does builder paint last on newer Johnstown homes?', a: 'Builder-grade paint applied during construction typically shows chalking, fading, and edge failures within 4Ã¢â‚¬â€œ6 years in Northern Colorado. We replace it with premium two-coat systems using Sherwin-Williams Duration or Benjamin Moore Aura Ã¢â‚¬â€ rated for 7Ã¢â‚¬â€œ10 years with proper surface prep.' },
      ...
      { q: 'What commercial painting services do you offer in Johnstown?', a: 'We provide commercial exterior and interior painting for Johnstown businesses Ã¢â‚¬â€ retail, office, and multi-family properties. We schedule around business operations and carry $2M general liability insurance with COI available on request.' },
      { q: 'How do I get a painting quote in Johnstown?', a: 'Call (970) 670-3965 or fill out the quote form on this page. We provide on-site assessments in Johnstown and written quotes within 24 hours. We respond to all inquiries within minutes during business hours.' },
    ],
  },
};
