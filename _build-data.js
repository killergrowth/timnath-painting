...
const SERVICES = [
  { label: 'Exterior Painting',   slug: 'exterior-painting',   icon: 'fa-solid fa-house',             img: 'img-4932-exterior.jpg', tagline: 'Coatings built to handle Colorado freeze-thaw cycles â€” rated for 7-10 years.' },
...
<strong>Project Management:</strong> You get a dedicated project lead, weekly progress updates, and full site cleanup. No subcontractors. No volume rushing.`,
    faqs: [
      ...
      { q: 'What does exterior painting cost in Northern Colorado?', a: 'Most premium exterior painting projects for $650K+ homes range from $8,000-$18,000+ depending on home size, siding type, and surface condition. Call (970) 670-3965 for an accurate quote based on your specific home.' },
    ],
  },
  'hoa-painting': {
...
const CITY_DATA = {
  'timnath-co': {
    ...
    intro: `Timnath is one of the fastest-growing communities in Northern Colorado, with new construction neighborhoods and established HOA communities spreading east of I-25. The homes here are newer and premium â€” and the expectation for exterior appearance matches. Colorado's 28+ freeze-thaw cycles and intense UV exposure hit every home in Timnath the same way, regardless of age. Paint systems that aren't designed for Zone 5b conditions fail early.\n\nTimnath Painting is based here. We know the neighborhoods, the HOA requirements, and the local conditions better than anyone. Licensed, Insured, and Eco-Painter Certified with $2M general liability coverage.`,
    faqs: [
      { q: 'Do you serve the Timnath area?', a: 'Yes â€” Timnath is our home base. We serve all neighborhoods in Timnath including newer HOA communities east of I-25. We\x27re on-site in Timnath regularly and can typically schedule faster here than in other cities.' },
  ...
  'windsor-co': {
    ...
    faqs: [
      ...
      { q: 'Do you handle HOA color approvals in Windsor?', a: 'Yes. Windsor has a number of HOA communities with strict color approval requirements. We handle the full documentation process â€” color samples, approval submissions, and compliance letters â€” on your behalf.' },
  ...
  'severance-co': {
    ...
    faqs: [
      ...
      { q: 'Can you paint the exterior of an older farmhouse or rural property in Severance?', a: 'Yes. Older homes and rural properties often have more prep work involved â€” failed paint, wood rot, compromised caulk, and weathered surfaces. We assess all of this upfront and factor it into the quote. We don\'t charge extra for thorough prep; we treat it as part of every project.' },
  ...
  'fort-collins-co': {
    ...
    intro: `Fort Collins is the largest city in Northern Colorado and has one of the most diverse housing stocks in the region â€” historic Craftsman and Victorian homes in Old Town, mid-century builds in established neighborhoods, and newer subdivisions spreading south and east. Each era of construction comes with its own set of coating challenges. Historic homes require careful prep, lead paint awareness, and specialty primers. Newer builds need proper topcoat systems, not just builder repaints.\n\nTimnath Painting serves Fort Collins with the same standards we apply everywhere â€” Licensed, Insured, Eco-Painter Certified, $2M general liability. Sherwin-Williams and Benjamin Moore coatings. No subcontractors.`,
    faqs: [
      ...
      { q: 'Can you paint historic homes in Old Town Fort Collins?', a: 'Yes. Older homes in Old Town require special attention â€” lead paint testing and containment on pre-1978 homes, oil-based primers for chalky or bare wood surfaces, and careful prep to avoid damaging historic trim detail. We\'re experienced with the specific challenges of older Fort Collins housing stock.' },
      { q: 'How long does exterior paint last on Fort Collins homes?', a: 'Most Fort Collins homes see the same Northern Colorado climate as the rest of the region â€” 28+ freeze-thaw cycles, intense UV, and temperature swings. Budget paint fails in 3â€“4 years. Premium systems using Sherwin-Williams Duration or Benjamin Moore Aura last 7â€“10 years with proper prep.' },
      ...
      { q: 'What Fort Collins neighborhoods do you serve?', a: 'We serve all of Fort Collins â€” Old Town, Midtown, Fossil Creek, Harmony, Rigden Farm, Sidehill, and new developments in southeast and southwest Fort Collins. Call (970) 670-3965 for availability in your specific neighborhood.' },
    ],
  },
  'loveland-co': {
    label: 'Loveland',
    ...
    intro: `Loveland sits along the Front Range at the foot of the Big Thompson Canyon â€” scenic, but that also means direct UV exposure, wind, and temperature swings that challenge exterior paint systems year-round. The city has a mix of established mid-century neighborhoods near downtown and newer developments spreading south and east toward Johnstown. Both require proper exterior coating systems to survive Northern Colorado's climate.\n\nTimnath Painting serves Loveland with the same Eco-Painter Certified crew, premium Sherwin-Williams and Benjamin Moore coatings, and thorough prep that protects every project for 7â€“10 years. Licensed, Insured, $2M general liability.`,
    faqs: [
      ...
      { q: 'Can you paint older Loveland homes?', a: 'Yes. We handle older homes with the appropriate prep â€” scraping to stable substrate, oil-based or shellac primers on bare wood, elastomeric caulking on all gaps, and pressure washing before any coating goes on. Thorough prep is the difference between a 4-year job and a 10-year system.' },
  ...
  'johnstown-co': {
    ...
    intro: `Johnstown has grown significantly along the I-25 corridor between Loveland and Greeley, with newer residential neighborhoods and commercial development continuing to expand. Most homes here are newer builds â€” but newer doesn\'t mean immune to Colorado\'s climate. Freeze-thaw cycles, intense UV, and temperature swings that can exceed 60Â°F in a single day stress even recently applied builder-grade paint systems.\n\nTimnath Painting serves Johnstown with the same approach: thorough prep, premium Sherwin-Williams and Benjamin Moore coatings rated for 7â€“10 years, and an Eco-Painter Certified crew. Licensed, Insured, $2M general liability.`,
    faqs: [
      ...
      { q: 'How long does builder paint last on newer Johnstown homes?', a: 'Builder-grade paint applied during construction typically shows chalking, fading, and edge failures within 4â€“6 years in Northern Colorado. We replace it with premium two-coat systems using Sherwin-Williams Duration or Benjamin Moore Aura â€” rated for 7â€“10 years with proper surface prep.' },
      ...
      { q: 'What commercial painting services do you offer in Johnstown?', a: 'We provide commercial exterior and interior painting for Johnstown businesses â€” retail, office, and multi-family properties. We schedule around business operations and carry $2M general liability insurance with COI available on request.' },
