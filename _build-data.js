...
const CLIENT = {
  ...
  state: 'CO',
  zip: '80547',
  facebook: 'https://facebook.com/keystonepainting',
...
<strong>Documentation:</strong> Certificates of insurance available within 24 hours. We coordinate with property managers on access, security, and scheduling requirements.`,
    ...
    whyUs: `Commercial painting bids are easy to get. Reliable execution is harder to find. The crew that assesses your project is the crew that does the work. The same people show up on day one and day five â€” no quality variation, no scheduling gaps.
